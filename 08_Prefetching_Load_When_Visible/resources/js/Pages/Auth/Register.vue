    ...
    <div class="min-h-screen flex flex-col items-center justify-center bg-gray-100">
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mb-4">
                ...
                <input v-model="form.email" class="border py-2 px-3" id="email" type="email" placeholder="email@example.com">
            ...
            <div class="mb-6">
                ...
                <input v-model="form.password_confirmation" class="border py-2 px-3" id="password_confirmation" type="password"
                    placeholder="******************">
            </div>
            <div class="flex items-center justify-between">
                <button class="bg-blue-400 hover:bg-blue-700 text-white py-2 px-4" type="submit">
                    Register
                </button>
            </div>
        </form>
